...
export default function LatestTips() {
  ...
  const handleScroll = (e: React.UIEvent<HTMLDivElement>) => {
    ...
    if (clientWidth > 0) {
      setScrollIdx(Math.min(ARTICLES.length - 1, Math.max(0, Math.round(scrollLeft / (clientWidth * 0.8)))));
    }
  };
  ...
  return (
    <section className="py-20 bg-white border-b border-slate-100" id="reviews">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div onScroll={handleScroll} className="flex overflow-x-auto pb-4 gap-6 scrollbar-thin snap-x snap-mandatory -mx-6 px-6 md:mx-0 md:px-0 md:grid md:grid-cols-3 md:gap-8">
